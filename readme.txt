...
This plugin connects to the Teecontrol API to obtain information from your Teecontrol golf course.
The following data will be obtained from your Teecontrol golf course:
- Course agenda;
- Course status.
